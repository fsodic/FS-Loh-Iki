...
public class g<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: a.c.g<K, V> */
    ...
    public void a(g<? extends K, ? extends V> gVar) {
        ...
        if (this.g != 0) {
            ...
            System.arraycopy(gVar.e, 0, this.e, 0, i);
            System.arraycopy(gVar.f, 0, this.f, 0, i << 1);
            this.g = i;
        }
    }
