...
public final class d<E> implements Collection<E>, Set<E> {
    ...
    private static final int[] f24a = new int[0];

    /* renamed from: b  reason: collision with root package name */
    private static final Object[] f25b = new Object[0];

    /* renamed from: c  reason: collision with root package name */
    private static Object[] f26c;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: a.c.d<E> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Collection, java.util.Set
    public boolean addAll(Collection<? extends E> collection) {
        h(this.i + collection.size());
