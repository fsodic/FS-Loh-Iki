...
public class l {
    ...
    private static Map<Class, Integer> f227a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static Map<Class, List<Constructor<? extends d>>> f228b = new HashMap();
    ...
    static e a(Object obj) {
        ...
        List<Constructor<? extends d>> list = f228b.get(cls);
        if (list.size() == 1) {
    ...
    private static int b(Class<?> cls) {
        if (f227a.containsKey(cls)) {
            return f227a.get(cls).intValue();
        }
        int d = d(cls);
        f227a.put(cls, Integer.valueOf(d));
        return d;
    }
    ...
    private static int d(Class<?> cls) {
        ...
        if (a2 != null) {
            f228b.put(cls, Collections.singletonList(a2));
            return 2;
        } else if (a.f209a.b(cls)) {
            return 1;
        } else {
            ...
            if (c(superclass)) {
                ...
                arrayList = new ArrayList(f228b.get(superclass));
            }
            ...
            for (Class<?> cls2 : interfaces) {
                if (c(cls2)) {
                    ...
                    arrayList.addAll(f228b.get(cls2));
                }
            }
            if (arrayList == null) {
                return 1;
            }
            f228b.put(cls, arrayList);
            return 2;
        }
    }
}
