...
public final class Jka {
    ...
    public static final int f2347a = ((Build.VERSION.SDK_INT == 25 && Build.VERSION.CODENAME.charAt(0) == 'O') ? 26 : Build.VERSION.SDK_INT);

    /* renamed from: b  reason: collision with root package name */
    public static final String f2348b = Build.DEVICE;

    /* renamed from: c  reason: collision with root package name */
    public static final String f2349c = Build.MANUFACTURER;
    ...
    public static ExecutorService a(String str) {
        return Executors.newSingleThreadExecutor(new Mka(str));
    }

    public static void a(AbstractC1213eka eka) {
        if (eka != null) {
            try {
                eka.close();
