...
abstract class Iaa implements AbstractC1333gba {

    /* renamed from: a  reason: collision with root package name */
    private static final int[] f2233a = b(new byte[]{101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107});
    ...
    static void a(int[] iArr, int[] iArr2) {
        ...
        System.arraycopy(iArr2, 0, iArr, f2233a.length, 8);
    }
    ...
    public final void a(ByteBuffer byteBuffer, byte[] bArr) {
        if (byteBuffer.remaining() - a() >= bArr.length) {
            byte[] a2 = C1677lba.a(a());
            byteBuffer.put(a2);
            ByteBuffer wrap = ByteBuffer.wrap(bArr);
            int remaining = wrap.remaining();
            int i = (remaining / 64) + 1;
            for (int i2 = 0; i2 < i; i2++) {
                ByteBuffer a3 = a(a2, this.f2235c + i2);
                if (i2 == i - 1) {
                    Gaa.a(byteBuffer, wrap, a3, remaining % 64);
                } else {
                    Gaa.a(byteBuffer, wrap, a3, 64);
                }
            }
            return;
        }
