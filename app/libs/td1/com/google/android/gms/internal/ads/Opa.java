...
public final class Opa extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        Bundle a2 = a(context);
        C1340gf a3 = C1340gf.a();
        if (a2 == null) {
            C0745Vl.b("Metadata was null.");
        } else {
            try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str2)) {
                                        ...
                                        C0745Vl.a(valueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                    } else {
                                ...
                                C0745Vl.a(valueOf2.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf2) : new String("Publisher provided Google AdMob App ID in manifest: "));
