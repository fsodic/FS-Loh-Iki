...
public final class Uaa {
    ...
    public static KeyPair a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator a2 = Xaa.h.a("EC");
        a2.initialize(eCParameterSpec);
        return a2.generateKeyPair();
    }

    public static ECPublicKey a(Waa waa, byte[] bArr, byte[] bArr2) {
        ECParameterSpec a2 = a(waa);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        a(eCPoint, a2.getCurve());
        return (ECPublicKey) Xaa.i.a("EC").generatePublic(new ECPublicKeySpec(eCPoint, a2));
    }

    public static ECParameterSpec a(Waa waa) {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        int i = Taa.f3186b[waa.ordinal()];
        if (i == 1) {
            ...
            String valueOf = String.valueOf(waa);
    ...
    public static byte[] a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        ...
        PublicKey generatePublic = Xaa.i.a("EC").generatePublic(new ECPublicKeySpec(eCPoint, eCPrivateKey.getParams()));
        KeyAgreement a2 = Xaa.g.a("ECDH");
        ...
        try {
            ...
            if (a3.signum() == 1) {
                ...
                if (mod2.equals(BigInteger.ZERO)) {
                        ...
                        while (true) {
                            ...
                            if (modPow.add(BigInteger.ONE).equals(a3)) {
                                ...
                                for (int bitLength = shiftRight2.bitLength() - 2; bitLength >= 0; bitLength--) {
                                    ...
                                    bigInteger4 = bigInteger4.multiply(bigInteger4).add(bigInteger3.multiply(bigInteger3).mod(a3).multiply(mod3)).mod(a3);
                                    bigInteger3 = multiply.add(multiply).mod(a3);
                                    if (shiftRight2.testBit(bitLength)) {
                                        BigInteger mod4 = bigInteger4.multiply(bigInteger2).add(bigInteger3.multiply(mod3)).mod(a3);
                                        bigInteger3 = bigInteger2.multiply(bigInteger3).add(bigInteger4).mod(a3);
                                        bigInteger4 = mod4;
                                    }
                                }
                    ...
                    if (!(bigInteger2 == null || bigInteger2.multiply(bigInteger2).mod(a3).compareTo(mod2) == 0)) {
