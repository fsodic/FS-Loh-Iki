...
public final class C1311gH {
    ...
    public static ArrayList<C1357gna.a> a(SQLiteDatabase sQLiteDatabase) {
        ArrayList<C1357gna.a> arrayList = new ArrayList<>();
        Cursor query = sQLiteDatabase.query("offline_signal_contents", new String[]{"serialized_proto_data"}, null, null, null, null, null);
        while (query.moveToNext()) {
            try {
                arrayList.add(C1357gna.a.a(query.getBlob(query.getColumnIndexOrThrow("serialized_proto_data"))));
            } catch (Bca e) {
                C0745Vl.b("Unable to deserialize proto from offline signals database:");
                C0745Vl.b(e.getMessage());
            }
        }
        query.close();
        return arrayList;
