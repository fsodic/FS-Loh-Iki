...
final class C0995bea extends Zda {
    C0995bea() {
    }
    ...
    public final int a(int r12, byte[] r13, int r14, int r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C0995bea.a(int, byte[], int, int):int");
    }
    ...
    public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                throw new C0926aea(i7 - 1, length);
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (_da.a(b3)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        _da.a(b3, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw Bca.i();
                    ...
                    byte b5 = bArr[i6];
                    int i10 = i9 + 1;
                    _da.a(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw Bca.i();
