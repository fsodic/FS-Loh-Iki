...
public class Cocos2dxHelper {
    ...
    private static ServiceConnection connection = new ServiceConnectionC2698ia();
    private static a mGameServiceBinder = null;
    ...
    private static b sOBBFile = null;
    ...
    public static String getAssetsPath() {
        String str = sAssetsPath;
        String str2 = BuildConfig.FLAVOR;
        if (str.equals(str2)) {
            String str3 = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/obb/" + sPackageName;
            String[] list = new File(str3).list(new C2696ha());
    ...
    public static long[] getObbAssetFileDescriptor(String str) {
        ...
        if (!(getObbFile() == null || (b2 = getObbFile().b(str)) == null)) {
            try {
    ...
    public static b getObbFile() {
        if (sOBBFile == null) {
            ...
            try {
                sOBBFile = b.a.a.a.a.a.b(Cocos2dxActivity.getContext(), i, 0);
    ...
    public static boolean hasSoftKeys() {
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            return !ViewConfiguration.get(sActivity).hasPermanentMenuKey() && !KeyCharacterMap.deviceHasKey(4);
        }
    }
    ...
    public static void setEditTextDialogResult(String str) {
        try {
            sCocos2dxHelperListener.runOnGLThread(new RunnableC2700ja(str.getBytes("UTF8")));
