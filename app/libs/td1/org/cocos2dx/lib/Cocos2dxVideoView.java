...
public class Cocos2dxVideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private MediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new C2714qa(this);
    protected Cocos2dxActivity mCocos2dxActivity = null;
    private MediaPlayer.OnCompletionListener mCompletionListener = new C2708na(this);
    private int mCurrentBufferPercentage;
    private int mCurrentState = 0;
    private int mDuration;
    private MediaPlayer.OnErrorListener mErrorListener = new C2712pa(this);
    ...
    MediaPlayer.OnPreparedListener mPreparedListener = new C2706ma(this);
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder$CallbackC2716ra(this);
    private int mSeekWhenPrepared;
    protected MediaPlayer.OnVideoSizeChangedListener mSizeChangedListener = new C2704la(this);
    ...
    public boolean isInPlaybackState() {
        int i;
        return (this.mMediaPlayer == null || (i = this.mCurrentState) == STATE_ERROR || i == 0 || i == 1) ? false : true;
    }
